            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
                ...
                <div class="glass p-6 rounded-[24px] flex items-center gap-4 relative overflow-hidden md:col-span-1">
                    ...
                    <div>
                        ...
                        <p id="stat-total" class="text-2xl font-black text-emerald-50">0</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div class="glass p-6 rounded-[30px] border border-emerald-500/10">
                        <h3 class="text-xs font-bold uppercase mb-4 text-slate-500 tracking-wider flex items-center gap-2"><i class="fa-solid fa-keyboard"></i> Input Manual</h3>
                        <form id="form-add" class="flex flex-col gap-4">
                            ...
                            <div class="flex gap-3"><input type="text" id="add-nim" placeholder="NIM" required class="input-modern p-3 rounded-xl text-sm w-2/3 font-mono"><input type="number" step="0.01" id="add-ipk" placeholder="IPK" required class="input-modern p-3 rounded-xl text-sm w-1/3 font-semibold"></div>
                            <select id="add-jurusan" class="input-modern p-3 rounded-xl text-sm font-semibold cursor-pointer"><option>Teknik Informatika</option><option>Sistem Informasi</option><option>Teknik Elektro</option><option>Akuntansi</option></select>
                ...
                <div class="lg:col-span-8 glass rounded-[30px] overflow-hidden flex flex-col min-h-[800px] border border-emerald-500/10 shadow-2xl">
                    <div class="p-8 border-b border-emerald-900/20 bg-emerald-900/20 backdrop-blur-sm flex justify-between items-center sticky top-0 z-20">
                        <div><h2 class="font-bold text-emerald-50 text-2xl">Database Mahasiswa</h2><p class="text-xs text-emerald-400/60 mt-1 font-mono">Real-time Data View</p></div>
